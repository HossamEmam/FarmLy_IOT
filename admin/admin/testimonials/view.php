...
if (isset($_POST['delete'])) {
    $cat->obj->all_data->testimonials->set_id($cat->obj->simple_crypt($_POST['id'], "encrypts"));
    $delete = $cat->delete_testimonials();
    if ($delete) {
        $_SESSION['success'] = '<div class="alert alert-success"><strong>Well done!</strong>
                                You successfully Deleted Testimonial (' . $cat->obj->all_data->testimonials->get_id() . ')</div>';
...
<div class="panel panel-primary">
    ...
    font-family: cursive;">View Testimonials
        </div>
        ...
        <table class="table table-bordered datatable" id="table-3">
            ...
            foreach ($cat2 as $Category) {
                ...
                <tr class='odd gradeX'>
                    ...
                    <td> <?php echo $Category['job']; ?></td>
                    <td> <?php echo $Category['desc']; ?></td>
                    <td><img style='width:200px;  height:150px'
                             src='admin/testimonials/images/<?php echo $Category['image']; ?>'/></td>
                    ...
                    <td align="center">
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-blue" role="menu" style="    margin-left: -118%;">
                                <li><a href="main.php?edittestimonial=<?php echo $id; ?>"
                                       class="">
                                        Edit
                                    </a>
                                </li>
