...
if (isset($_POST['delete'])) {
    $cat->obj->all_data->Client->set_id($cat->obj->simple_crypt($_POST['id'], "encrypts"));
    $delete = $cat->delete_client();
    if ($delete) {
        $_SESSION['success'] = '<div class="alert alert-success"><strong>Well done!</strong>
                                You successfully Deleted Client (' . $cat->obj->all_data->Client->get_id() . ')</div>';
...
<div class="panel panel-primary">
    ...
    font-family: cursive;">View Clients
        </div>
            ...
            foreach ($cat2 as $Category) {
                ...
                <tr class='odd gradeX'>
                    ...
                    <td><img style='width:200px;  height:150px'
                             src='admin/clients/images/<?php echo $Category['image']; ?>'/></td>
                    ...
                    <td align="center">
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-blue" role="menu" style="    margin-left: -118%;">
                                <li><a href="main.php?editclient=<?php echo $id; ?>"
                                       class="">
                                        Edit
                                    </a>
                                </li>
