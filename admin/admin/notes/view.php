...
if (isset($_POST['delete'])) {
    $cat->obj->all_data->notes->set_id($cat->obj->simple_crypt($_POST['id'], "encrypts"));
    $delete = $cat->delete_note();
    if ($delete) {
        $_SESSION['success'] = '<div class="alert alert-success"><strong>Well done!</strong>
                                You successfully Deleted Note (' . $cat->obj->all_data->notes->get_id() . ')</div>';
...
<div class="panel panel-primary">
    ...
    font-family: cursive;">View Notes
        </div>
                    ...
                    <td align="center">
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-blue" role="menu" style="    margin-left: -118%;">
                                <li><a href="main.php?edit_note=<?php echo $id; ?>"
                                       class="">
                                        Edit
                                    </a>
                                </li>
